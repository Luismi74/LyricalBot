...
genius = lg.Genius(GENIUS_TOKEN, skip_non_songs=True,
...
def genius_song(artist_str):
    ...
    lyrics = select_song.save_lyrics(
        'lyrics.json', overwrite=True, extension='json')
...
def lyrics_cleaning(converted_lyrics):
    list_tags = [(5, 7), (10, 12), (3, 5), (6, 8), (16, 18),
                 (2, 4), (3, 5), (7, 9), (4, 6), (6, 10)]
